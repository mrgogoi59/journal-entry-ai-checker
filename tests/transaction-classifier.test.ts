...
describe("classifyTransaction supported beginner transactions", () => {
  it.each([
    ...
    ["Paid for telephone bill Rs.1000 in cash", "paid_telephone_cash", "Telephone Expense", "Cash", 1000],
    ["Paid telefone expense Rs.1200 through bank", "paid_telephone_bank", "Telephone Expense", "Bank", 1200],
    ["Paid internet bill Rs.1500 by UPI", "paid_internet_bank", "Internet Expense", "Bank", 1500],
    ["Paid for internet bill Rs.1500 by UPI", "paid_internet_bank", "Internet Expense", "Bank", 1500],
    ["Paid travelling expenses Rs.2000 in cash", "paid_travelling_cash", "Travelling Expense", "Cash", 2000],
    ["Paid for travel tickets Rs.5000 by cash", "paid_travelling_cash", "Travelling Expense", "Cash", 5000],
    ["Paid for travel tickets Rs.5000 in cash", "paid_travelling_cash", "Travelling Expense", "Cash", 5000],
    ["Paid travel ticket expenses Rs.5000 in cash", "paid_travelling_cash", "Travelling Expense", "Cash", 5000],
    ["Paid travelling ticket expenses Rs.5000 by cash", "paid_travelling_cash", "Travelling Expense", "Cash", 5000],
    ["Paid bus fare Rs.5000 in cash", "paid_travelling_cash", "Travelling Expense", "Cash", 5000],
    ["Paid train fare Rs.5000 in cash", "paid_travelling_cash", "Travelling Expense", "Cash", 5000],
    ["Paid flight ticket Rs.5000 through bank", "paid_travelling_bank", "Travelling Expense", "Bank", 5000],
    ["Paid travel fare Rs.5000 by UPI", "paid_travelling_bank", "Travelling Expense", "Bank", 5000],
    ...
    ["Paid for office expenses Rs.2500 through bank", "paid_office_expenses_bank", "Office Expenses", "Bank", 2500],
    ["Received commission Rs.3000 in cash", "commission_received_cash", "Cash", "Commission Income", 3000],
    ["Recieved commission Rs.2500 in cash", "commission_received_cash", "Cash", "Commission Income", 2500],
    ["Recieved commision Rs.2500 in cash", "commission_received_cash", "Cash", "Commission Income", 2500],
    ...
    ["Received Rs.10000 from Raju in cash", "received_from_named_debtor", "Cash", "Raju", 10000],
  ...
  it.each([
    ["Sold machinery costing Rs.50000 for Rs.40000 cash", "asset_sale_loss_machinery_cash", "Cash", "Machinery", 40000],
    ["Sold machinery costing Rs.50000 for Rs.60000 cash", "asset_sale_profit_machinery_cash", "Cash", "Machinery", 60000],
    ["Sold laptop costing Rs.30000 for Rs.20000 through bank", "asset_sale_loss_laptop_bank", "Bank", "Computer", 20000],
    ["Sold car costing Rs.300000 to Raju for Rs.250000 on credit", "asset_sale_loss_vehicle_credit", "Raju", "Vehicle", 250000],
    ["Machinery book value Rs.50000 sold for Rs.60000 cash", "asset_sale_profit_machinery_cash", "Cash", "Machinery", 60000],
    ["Sold machinery having book value Rs.50000 for Rs.40000 cash", "asset_sale_loss_machinery_cash", "Cash", "Machinery", 40000],
  ])("classifies asset sale with profit/loss: %s", (transaction, transactionType, debitAccount, creditAccount, amount) => {
    const classification = classifyTransaction(transaction);
  ...
  it("builds expected entries for asset sales with profit or loss", () => {
    const lossCash = classifyTransaction("Sold machinery costing Rs.50000 for Rs.40000 cash");
    const profitCash = classifyTransaction("Sold machinery costing Rs.50000 for Rs.60000 cash");
    const lossBank = classifyTransaction("Sold laptop costing Rs.30000 for Rs.20000 through bank");
    const lossCredit = classifyTransaction("Sold car costing Rs.300000 to Raju for Rs.250000 on credit");
    ...
    expect(generateExpectedEntry(lossBank!)).toEqual({
      debits: [
    ...
    expect(generateExpectedEntry(lossCredit!)).toEqual({
      debits: [
        { account: "Raju", amount: 250000, acceptedAccounts: ["Debtor"], partyRole: "debtor" },
