...
export function JournalEntrySolverExperience() {
  ...
  return (
    <section className="mx-auto flex w-full max-w-[1080px] flex-col gap-5 text-ink sm:gap-6">
        <header className="overflow-hidden rounded-2xl border border-blue-100 bg-gradient-to-br from-white via-blue-50 to-emerald-50 p-5 shadow-soft sm:p-8">
          <div className="mt-7 max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-8 text-slate-700">
              Use this as optional help when one transaction is confusing during Journal Entries learning or practice.
            </p>
            <p className="mt-4 rounded-xl border border-emerald-200 bg-white/80 px-4 py-3 text-sm font-medium leading-6 text-slate-700">
              This tool teaches the logic behind the entry, not just the answer. After using it, return to the chapter or
              beginner practice to keep learning.
            </p>
            <div className="mt-5 flex flex-wrap gap-2">
              <Link
                href="/chapters/journal-entries"
                className="inline-flex min-h-10 items-center rounded-xl border border-cyan-200 bg-white/90 px-3 text-sm font-bold text-cyan-900 transition hover:border-cyan-300 hover:bg-cyan-50"
              >
  ...
  return (
    <section className="rounded-2xl border border-blue-100 bg-blue-50/80 p-4 shadow-soft sm:p-6">
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-3">
        ...
        <ActionLink href="/chapters/journal-entries" variant="secondary">
          Return to Chapter
        </ActionLink>
