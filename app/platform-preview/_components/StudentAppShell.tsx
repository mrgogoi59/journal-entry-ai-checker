...
import type { PreviewNavigationId } from "./navigation";

export function StudentAppShell({ activeItem, children }: { activeItem: PreviewNavigationId; children: ReactNode }) {
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-50 text-slate-950">
      <a
        href="#platform-preview-content"
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-[17rem_minmax(0,1fr)]">
        ...
        <main id="platform-preview-content" className="min-w-0 px-4 py-5 sm:px-6 sm:py-7 lg:px-8">
