...
const tradingCreditAccounts = new Set([
  "sale",
  "sales",
  "purchase returns",
  "purchase return",
...
const logic = [
  ...
  "Direct expenses such as wages, carriage inward, freight inward, import duty, and factory expenses go to Trading A/c.",
  ...
  "Indirect expenses such as salary, rent, advertisement, repairs, legal charges, and office expenses go to Profit & Loss A/c.",
